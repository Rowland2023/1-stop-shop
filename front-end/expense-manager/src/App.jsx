...
function App() {
    ...
    useEffect(() => {
        ...
        // Optimized Ad Fetch with Header fix
        ...
        <div className="app-grid-wrapper">
            ...
            <nav className="main-nav">
                <ul>
                    ...
                    {/* RESTORED: Tracking and Account Buttons */}
                    <li><button className="nav-btn-link" onClick={() => setView("tracking")}>Track Order</button></li>
                    {user && <li><button className="nav-btn-link" onClick={() => setView("account")}>My Account</button></li>}
            ...
            <main>
                {isSuccess ? (
                    ...
                    <div className="view-container">
                        ...
                        <p>Tracking feature is coming soon to your dashboard.</p>
                    </div>
                ) : view === "account" ? (
                    <div className="view-container">
                        <h2>My Account</h2>
                        <p>Welcome, {user?.phone}. Here you can manage your profile.</p>
                        <button className="clear-cart-btn" style={{marginTop: '20px'}} onClick={() => setUser(null)}>Logout</button>
                    </div>
                ) : selectedProduct ? (
